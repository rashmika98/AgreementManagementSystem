...
public class QueryUtil extends CommonUtil {
	 ...
	 * 
	 * @see SellerServiceImpl#addSellers()
	 * @see SellerServiceImpl#createSellerTable()
	 * @see SellerServiceImpl#displayAllSellers()
	 * @see SellerServiceImpl#removeSeller(String)
	 * 
	 */
	public static String queryByID(String id) throws SAXException, IOException, ParserConfigurationException {
		 ...
		 */
		nodeList = DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new File(System.getProperty("catalina.base") + "\\wtpwebapps\\AgreementManagementSystem\\WEB-INF\\lib\\Query.xml"))
