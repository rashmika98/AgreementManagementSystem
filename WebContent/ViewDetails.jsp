			...
			<h3 for="validationCustom01">View the contract here!!!</h3>
			 ...
			 <div class="form-row">
			 	<div class="col-md-4 mb-3">
			      ...
			      <input type="text" class="form-control" id="validationCustom01" name = "fName" placeholder="Identification number" value="<%=record.getIdentification() %>"
			        required disabled>
			    </div>
			    <div class="col-md-4 mb-3">
			      <label for="validationCustom01">PDF ID</label>
			      <input type="text" class="form-control" id="validationCustom01" name = "fName" placeholder="PDF number" value="<%=record.getId() %>"
			        required disabled>
			    </div>
			    <div class="col-md-4 mb-3">
			      <label for="validationCustom01">Client Password</label>
			      <input type="text" class="form-control" id="validationCustom01" name = "fName" placeholder="Password" value="<%=record.getPassword() %>"
			        required disabled>
			    </div>
			 </div>
			  <div class="form-row">
